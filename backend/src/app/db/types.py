...
class GUID(PGUUID):
    ...
    `.hex` during binding, which fails if a plain string is passed. This
    subclass accepts strings, converts them to uuid.UUID when possible, and
    then defers to the normal PostgreSQL processor.
    """
