...
const PROCTORING_CONTROL_GROUPS = [
  {
    ...
    controls: [
      ...
      { key: 'face_verify_id_threshold', label: 'ID verification distance', desc: 'Lower is stricter. Tightens selfie-to-ID matching.', min: 0.3, max: 0.42, step: 0.01, unit: 'distance', enabledBy: 'identity_required' },
